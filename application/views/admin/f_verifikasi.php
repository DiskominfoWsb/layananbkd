...
<?php
	...
	<button type="submit" class="btn btn-info">Download</button>
		...
		<form action="<?=base_URL()?>admin/karis/set_bkd" method="post" accept-charset="utf-8" enctype="multipart/form-data">
...
<?php
	if($bkd =="SMS"){
?>
<form action="<?=base_URL()?>admin/karis/set_pertek" method="post" accept-charset="utf-8" enctype="multipart/form-data">
...
<form action="<?=base_URL()?>admin/karis/set_sk" method="post" accept-charset="utf-8" enctype="multipart/form-data">
...
?>
<form action="<?=base_URL()?>admin/karis/set_ket" method="post" accept-charset="utf-8" enctype="multipart/form-data">
		<input type="hidden" name="idp" value="<?php echo $idp; ?>">
