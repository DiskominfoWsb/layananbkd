...
<div class="navbar navbar-inverse"style="background-color:#3CB371;">
	...
	<div class="col-lg-6">
		...
		<tr><td width="30%">Jenis Kartu</td><td><select name="jenslks" class="form-control" style="width: 150px" readonly required><option value="<?php echo $jenslks;?>"> - Kategori - </option>
			<?php
