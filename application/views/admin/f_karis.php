...
<div class="navbar navbar-inverse"style="background-color:#3CB371;">
	<div class="container">
		<div class="navbar-header">
			<span class="navbar-brand" href="#">Usul karis</span>
		</div>
	</div><!-- /.container -->
</div><!-- /.navbar -->
	...
	?>
	<form action="<?=base_URL()?>admin/karis/add2" method="post" accept-charset="utf-8" enctype="multipart/form-data">
	...
	<div class="col-lg-6">	
		...
		<tr><td width="30%">Jenis karis</td><td><select name="jenkaris" class="form-control" style="width: 150px" required><option value="<?php echo $jenkaris;?>"> - Jenis karis - </option>
			<?php
		...
		<tr><td width="150%">Nama Suami/Isteri</td><td><b><input type="text" name="nm_pasangan" required value="<?php echo $nm_pasangan; ?>" id="nm_pasangan" style="width: 150px" class="form-control"></b></td></tr>
		<tr><td width="150%">Pekerjaan Suami/Isteri</td><td><b><input type="text" name="pekerjaan" required value="<?php echo $pekerjaan; ?>" id="pekerjaan" style="width: 150px" class="form-control"></b></td></tr>
