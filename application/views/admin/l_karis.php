...
//				$fbkd1		= $datpiltmp->fbkd;
		...
		<select class="form-control" name="fjenkaris">
		<option>- Pilih -</option>	
			<?php
...
<table id="example" class="table table-bordered table-hover">
	<thead>
		...
		<tr>
			...
			<th rowspan="2"  width="6%">Jenis Kartu</th>
	...
	<tbody>
		...
		<tr>
			...
			<?php
				...
				?>	
					<a href="<?=base_URL()?>admin/karis/detail/<?=$b->id?>" class="btn btn-info" title="detail">  Detail</a>
				</div>	
